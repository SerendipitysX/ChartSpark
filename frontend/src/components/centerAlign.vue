...
<template>
  <el-button-group size="small">
    <!-- 水平集中 -->
    <el-button :disabled="!mSelectMode" @click="position('centerH')"><svg t="1650442559691" class="icon"
        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3787" width="14" height="14">
        <path d="M885 607H544V417h192V227H544V24h-64v203H288v190h192v190H139v190h341v203h64V797h341z" p-id="3788">
        </path>
      </svg>
    </el-button>
    <!-- 水平垂直居中 -->
    <el-button :disabled="!mSelectMode" @click="position('center')"><svg t="1650852784867" class="icon"
        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2351" width="14" height="14">
    ...
    <!-- 垂直居中 -->
    <el-button :disabled="!mSelectMode" @click="position('centerV')"><svg t="1650442510967" class="icon"
        viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3412" width="14" height="14">
        <path
