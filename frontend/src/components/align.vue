...
<template>
  <el-button-group size="small">
    <!-- 水平对齐 -->
    <el-button :disabled="notMultiple()" @click="left"><svg t="1650442284704" class="icon" viewBox="0 0 1024 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2345" width="14" height="14">
        <path d="M80 24h64v976H80zM198 227h448v190H198zM198 607h746v190H198z" p-id="2346"></path>
      </svg>
    </el-button>
    <el-button :disabled="notMultiple()" @click="xcenter"><svg t="1650442754876" class="icon" viewBox="0 0 1024 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1514" width="14" height="14">
        <path
    ...
    <el-button :disabled="notMultiple()" @click="right"><svg t="1650442299564" class="icon" viewBox="0 0 1024 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2543" width="14" height="14">
        <path d="M944 1000h-64V24h64zM826 417H378V227h448zM826 797H80V607h746z" p-id="2544"></path>
      </svg>
    </el-button>
    <!-- 垂直对齐 -->
    <el-button :disabled="notMultiple()" @click="top"><svg t="1650442692910" class="icon" viewBox="0 0 1170 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1118" width="14" height="14">
        <path
    ...
    <el-button :disabled="notMultiple()" @click="ycenter"><svg t="1650442732396" class="icon" viewBox="0 0 1243 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1316" width="14" height="14">
        <path
    ...
    <el-button :disabled="notMultiple()" @click="bottom"><svg t="1650442674784" class="icon" viewBox="0 0 1170 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="920" width="14" height="14">
        <path
    ...
    <!-- 平均对齐 -->
    <el-button :disabled="notMultiple()" @click="xequation"><svg t="1650442800956" class="icon" viewBox="0 0 1024 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1910" width="14" height="14">
        <path
    ...
    <el-button :disabled="notMultiple()" @click="yequation"><svg t="1650442784286" class="icon" viewBox="0 0 1170 1024"
        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1712" width="14" height="14">
        <path
