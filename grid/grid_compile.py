...
def grid_compile(grid_img_list, sort_idx_array, h, h_highest, h_grid):
...
print(current_path)
image_path = os.path.join(current_path, 'data', 'a_carrot.png')
image_path = current_path + '\data\读书bar\/book1.png'
print(image_path)
# bg removal
img = Image.open(image_path)
img_removal = bg_removal(img, current_path)
# get box of correct object and get the total_h(h_total)
img_removal_correct, h_total, (h_highest, w, channel) = get_box_img(img)
# cut
