...
def table2img_pie(sizes, labels, aspect_ratio, title):
    ...
    fig.savefig('D:/speak/frontend/src/assets/preview/pie_preview.png', dpi=fig.dpi)
    return 'D:/speak/frontend/src/assets/preview/pie_preview.png'
...
def img2mask_pie(sizes, labels, aspect_ratio):
    ...
    wedgeprops = {'linewidth' : 2, 'edgecolor' : 'black'}, colors=colors_mask_list)
    fig.savefig('output/mask/pie/mask_all.png', dpi=fig.dpi)
    ...
    for i in range(len(sizes)):
        ...
        fig.savefig('output/mask/pie/mask_'+ labels[i] +'.png', dpi=fig.dpi)
