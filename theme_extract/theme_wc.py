...
class WordCloudGenerator:
    ...
    def generate_wordcloud(self):
        ...
        self.d = {'blossom': 21.0, 'bloom': 17.0, 'flower': 15.5, 'cherry': 15.5, 'date': 16.5, 'venue': 14.0, 'dates': 14, 'timeslot': 14.0}
        ...
        plt.axis('off') 
        plt.gca().set_title("")
        plt.savefig("D:/speak/frontend/src/assets/wordcloud/wc.png", bbox_inches = 'tight', pad_inches = 0) 
        print("-----------------------")
        return "D:/speak/frontend/src/assets/wordcloud/wc.png",
